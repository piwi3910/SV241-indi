...
private:
    ...
    static constexpr int CH_DC1 = 0;
    static constexpr int CH_DC2 = 1;
    static constexpr int CH_DC3 = 2;
    static constexpr int CH_DC4 = 3;
    static constexpr int CH_DC5 = 4;
    static constexpr int CH_USB12 = 5;
    static constexpr int CH_USB345 = 6;
    static constexpr int CH_PWM13 = 7;
    static constexpr int CH_PWM14 = 8;
    static constexpr int CH_PWM15 = 9;
